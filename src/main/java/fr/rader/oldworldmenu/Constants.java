...
public class Constants {
    ...
    public static final Text WORLD_DIRECTORY_NAME_LABEL = Text.translatable("oldworldmenu.selectWorld.resultFolder");
    ...
    public static final Text MORE_WORLD_OPTIONS_TEXT = Text.translatable("oldworldmenu.selectWorld.moreWorldOptions");
